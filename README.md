...
## Versions: 
This project is currently in stable version 1.0.0.2. It is designed for Minecraft Spigot versions between 1.7.x and 1.13.x. The latest version can be found in the 'releases' section, and the most recent (possibly unstable) build can be found in the 'Jar' folder (currently version 1.0.0.4). 
